...
function update(){
    ...
    if(!$pdo){
        ...
        $sql = $pdo->prepare("UPDATE student_app SET fname = :fname, lname = :lname , dob = :dob , gender = :gender , apply = :apply , street_add = :street_add , street_add_2 = :street_add_2 , city = :city , region = :region , postal_zip = :postal_zip , status = :status WHERE id = '$id'");
